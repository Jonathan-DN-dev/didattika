        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16">
          ...
          <div className="flex flex-col items-center text-center lg:text-left lg:items-start max-w-lg">
            ...
            <p className="text-black text-base md:text-lg leading-relaxed mb-8 max-w-md font-overpass">
              Crea il tuo account e accedi al tuo spazio intelligente. La scuola come non l'hai mai vissuta.
            </p>
            ...
            {/* Login Link */}
            <p className="text-black text-sm font-overpass mb-6">
              Hai già un account?{' '}
              <Link href="/login" className="text-didattika-blue font-medium hover:underline">
                Accedi qui
              </Link>
            </p>
